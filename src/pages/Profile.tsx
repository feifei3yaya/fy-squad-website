...
const sponsors = [
  { date: '2026-05', amount: '¥50', method: '微信' },
  { date: '2026-04', amount: '¥30', method: '支付宝' },
  { date: '2026-03', amount: '¥50', method: '微信' },
];

const bookmarks = [
  { title: '载具编队与反装甲战术', type: '视频' },
  { title: '小队长快速参考卡', type: '资源' },
  { title: 'Narva 俄军防守布阵详解', type: '图文' },
];
        ...
        <div className="panel p-4 sm:p-6 mb-6 sm:mb-8 hud-corners">
          <div className="flex items-center gap-4 sm:gap-5">
            <div className="relative group">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-fy-surface border border-fy-green-dim/30 flex items-center justify-center shrink-0 overflow-hidden">
            ...
            <div>
              ...
              <div className="flex items-center gap-3 sm:gap-4 mt-1">
                <span className="data-label">UID: 0001</span>
                <span className="font-mono text-[10px] text-fy-green tracking-wider">● ACTIVE</span>
              </div>
            </div>
